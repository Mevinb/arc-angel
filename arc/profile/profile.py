...
preferences and achievements so ARC can answer questions like:
...
logger = logging.getLogger("arc.profile")
...
PROFILE_EXAMPLE: Dict[str, Any] = {
    ...
    "projects": [
        {"name": "ARC", "description": "Personal AI assistant orchestrating LLM "
